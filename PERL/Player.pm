# We may not need this because we're converting from a procedural/polling paradigm to
# an OO event driven paradigm.
...
# * Inputs          : A reference to a player in the player_list.           **/
# * Outputs         : None.                                                 **/
# * Programmer(s)   : Dominic Caffey.                                       **/
